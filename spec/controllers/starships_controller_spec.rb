...
RSpec.describe StarshipsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested starship as @starship" do
      starship = Starship.create! valid_attributes
      get :show, params: {id: starship.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested starship as @starship" do
      starship = Starship.create! valid_attributes
      get :edit, params: {id: starship.to_param}, session: valid_session
      expect(assigns(:starship)).to eq(starship)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Starship" do
        expect {
          post :create, params: {starship: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved starship as @starship" do
        post :create, params: {starship: invalid_attributes}, session: valid_session
        expect(assigns(:starship)).to be_a_new(Starship)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "assigns the requested starship as @starship" do
        starship = Starship.create! valid_attributes
        put :update, params: {id: starship.to_param, starship: valid_attributes}, session: valid_session
        expect(assigns(:starship)).to eq(starship)
      end
    ...
    context "with invalid params" do
      it "assigns the starship as @starship" do
        starship = Starship.create! valid_attributes
        put :update, params: {id: starship.to_param, starship: invalid_attributes}, session: valid_session
        expect(assigns(:starship)).to eq(starship)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested starship" do
      starship = Starship.create! valid_attributes
      expect {
        delete :destroy, params: {id: starship.to_param}, session: valid_session
      }.to change(Starship, :count).by(-1)
    end
